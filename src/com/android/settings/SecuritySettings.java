...
public class SecuritySettings extends RestrictedSettingsFragment
    ...
    private PreferenceScreen createPreferenceHierarchy() {
        ...
        mQuickUnlock = (CheckBoxPreference) root.findPreference(LOCKSCREEN_QUICK_UNLOCK_CONTROL);
    ...
    public void onResume() {
        ...
        if (mQuickUnlock != null) {
            mQuickUnlock.setChecked(lockPatternUtils.getQuickUnlock());
        }
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        if (KEY_UNLOCK_SET_OR_CHANGE.equals(key)) {
            ...
            lockPatternUtils.setQuickUnlock(isToggled(preference));
